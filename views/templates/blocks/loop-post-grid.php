...
<article <?php post_class( 'gutengeek-grid-view' ); ?>>
	...
	<div class="gutengeek-grid-post-inner">
		...
		gutengeek_get_template( 'blocks/post/complete-box.php', [ 'attributes' => $attributes ] );

		/**
		 * post thumbnail
		 */
		gutengeek_get_template( 'blocks/post/thumbnail.php', [ 'attributes' => $attributes ] );
		...
		<div class="gutengeek-post-side">
			<div class="gutengeek-post__text">
				 ...
				 * post title
				 */
				gutengeek_get_template( 'blocks/post/title.php', [ 'attributes' => $attributes ] );

				/**
				 * post meta
				 */
				gutengeek_get_template( 'blocks/post/meta.php', [ 'attributes' => $attributes ] );

				/**
				 * post excerpt
				 */
				gutengeek_get_template( 'blocks/post/excerpt.php', [ 'attributes' => $attributes ] );

				/**
				 * post button
				 */
				gutengeek_get_template( 'blocks/post/button.php', [ 'attributes' => $attributes ] );
				?>
			</div>
		</div>
	</div>
