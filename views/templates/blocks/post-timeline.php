...
<div class="gutengeek-block-container gutengeek-block gutengeek-block-timeline gutengeek-timeline-outer-wrap <?php echo esc_attr( $align ); ?>" id="<?php echo esc_attr( $blockId ); ?>">
	...
	<div class="gutengeek-block-inner">
		<div class="gutengeek-block-content">
			...
			<!-- Block Heading -->
			<?php gtg_get_template( 'blocks/block-heading.php', [ 'attributes' => $attributes ] ); ?>
			<!-- End Block Heading -->
											...
											?>
												<article class="gutengeek-timeline-field gutengeek-timeline-item" key="<?php echo esc_attr( $index ); ?>">
													<div class="<?php echo esc_attr( gutengeek_timeline_get_align_classes( $attributes, $index ) ); ?>">
														<?php
															gtg_get_template( '/blocks/post-timeline/marker.php', [ 'attributes' => $attributes ] );
														?>
														<div class="<?php echo esc_attr( gutengeek_timeline_get_day_align_classes( $attributes, $index ) ); ?>">
															<div class="gutengeek-timeline-milestone">
																<div class="gutengeek-timeline-milestone-inner">
																	<?php
																		gtg_get_template( '/blocks/post-timeline/thumbnail.php', [ 'attributes' => $attributes ] )
																	?>

																	<div class="gutengeek-content">
																		<div class="gutengeek-timeline-date-hide gutengeek-timeline-date-inner">
																			<?php
																				gtg_get_template( '/blocks/post-timeline/date.php', [ 'attributes' => $attributes, 'class' => 'gutengeek-timeline-inner-date-new' ] );
																			?>
																		</div>
																		<?php
																		/**
																		 * post timeline title
																		 */
																		gtg_get_template( '/blocks/post-timeline/title.php', [ 'attributes' => $attributes ] );

																		/**
																		 * post timeline author
																		 */
																		gtg_get_template( '/blocks/post-timeline/author.php', [ 'attributes' => $attributes, 'post' => $post ] );

																		/**
																		 * post timeline excerpt
																		 */
																		gtg_get_template( '/blocks/post-timeline/excerpt.php', [ 'attributes' => $attributes, 'post' => $post ] );

																		/**
																		 * post timeline excerpt
																		 */
																		gtg_get_template( '/blocks/post-timeline/readmore.php', [ 'attributes' => $attributes, 'post' => $post ] );
																		?>
														...
														<?php if ( ! isset($attributes['layout']) || 'center' === $attributes['layout'] ) { ?>
															<div class="gutengeek-timeline-date">
																<?php
																	gtg_get_template( '/blocks/post-timeline/date.php', [ 'attributes' => $attributes, 'class' => 'gutengeek-timeline-date' ] );
																?>
															</div>
														<?php } ?>
													</div>
