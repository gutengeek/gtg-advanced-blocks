...
class Api {
	...
	private function get_api_controllers() {
		return apply_filters( 'gutengeek_api_controllers', [
			'\GutenGeek\API\Core',
			'\GutenGeek\API\Template_Library'
		] );
	}
	...
	public function register_rest_fields() {
		$post_type = gutengeek_get_post_types();
		...
		foreach ( $post_type as $key => $value ) {
			...
			register_rest_field(
				...
				[
					'get_callback' => [ $this, 'gutengeek_total_comments' ],
					'update_callback' => null,
					'schema' => null,
				]
			);
	 ...
	 * @return mixed
	 */
	function gutengeek_total_comments( $object, $field_name, $request ) {
