	...
	final class Admin {
		...
		public static function admin_enqueue_scripts() {
			...
			if ( ! wp_script_is( 'gutengeek-components' ) ) {
				wp_enqueue_script( 'gutengeek-components', GTG_AB_URL . 'assets/js/admin/components.js', [ 'jquery', 'wp-util', 'updates', 'wp-element', 'wp-components', 'wp-block-editor', 'wp-editor' ], GTG_AB_VER );
