...
if ( ! function_exists( 'gtg_get_sm_breakpoint_setting' ) ) {
	...
	function gtg_get_sm_breakpoint_setting() {
		return apply_filters( 'gtg_get_sm_breakpoint_setting', gutengeek_get_setting( 'sm_breakpoint', GTG_AB_SM_BREAKPOINT ) );
	}
...
if ( ! function_exists( 'gtg_get_xs_breakpoint_setting' ) ) {
	...
	function gtg_get_xs_breakpoint_setting() {
		return apply_filters( 'gtg_get_xs_breakpoint_setting', gutengeek_get_setting( 'sm_breakpoint', GTG_AB_XS_BREAKPOINT ) );
	}
