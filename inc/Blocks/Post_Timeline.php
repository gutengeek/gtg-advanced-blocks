...
class Post_Timeline extends Block implements InterfaceBlock {
	...
	public function render_callback( $attributes ) {
		...
		$recent_posts = gutengeek_build_query( $attributes, 'timeline' );
		$post_tm_class = gutengeek_timeline_get_classes( $attributes );
		...
		ob_start();
		// print template html
		echo gutengeek_get_template_html( 'blocks/post-timeline.php', $template_args );
		return ob_get_clean();
	}
