...
class Gravity_Form extends Block implements InterfaceBlock {
	...
	public function render_callback( $attributes ) {
		...
		if ( $formId && 0 != $formId && -1 != $formId ) {
			?>
			<div id="<?php echo esc_attr( $blockId ); ?>" class="<?php echo esc_attr( $class ) ?> gutengeek-block-container gutengeek-block-gf gutengeek-gf-container align<?php echo esc_attr( $align ); ?>">
