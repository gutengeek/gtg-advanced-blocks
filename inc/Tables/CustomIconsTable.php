...
class CustomIconsTable extends \WP_List_Table {
	...
	public function get_items( $current_page = 1, $per_page = 10, $search = '', $status = '' ) {
		...
		$query = "SELECT SQL_CALC_FOUND_ROWS icon_id, icon_name, icon_dir_name, icon_user_id, icon_status FROM {$wpdb->prefix}gutengeek_block_icons WHERE 1 = 1 {$where} {$order}";
