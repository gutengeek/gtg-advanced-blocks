<?php
namespace GutenGeek\Modules\Icon_Sets;

use GutenGeek\Modules\CustomIcons;
...
abstract class Icon_Set_Base {
	...
	public function get_upload_folder_url() {
		 ...
		 * Upload file URL.
		 *
		 * Filters the URL to a file uploaded using GutenGeek forms.
		 *
	...
	public function get_icon_sets_dir() {
		...
		self::gutengeek_get_ensure_upload_dir( $path );
	...
	public function get_ensure_upload_dir( $dir = '' ) {
		...
		return self::gutengeek_get_ensure_upload_dir( $path );
	}
	...
	public static function gutengeek_get_ensure_upload_dir( $path ) {
