...
use GutenGeek\Abstracts\Module as AbstractModule;
...
class Module {
	...
	public function register_modules() {
		$this->register( 'custom_fonts', '\GutenGeek\Modules\CustomFonts' );
		$this->register( 'custom_icons', '\GutenGeek\Modules\CustomIcons' );
	}
