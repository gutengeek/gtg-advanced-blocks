...
class Post_Block extends Block {
	 ...
	 * @param string $layout
	 */
	public function gutengeek_get_post_html( $attributes = [], $query, $layout = 'grid' ) {
		...
		switch ( $layout ) {
			...
			case 'carousel':
				...
				$settings = [
					...
					'responsive' => [
						[
							'breakpoint' => absint( gutengeek_get_sm_breakpoint_setting() ),
							'settings' => [
						...
						[
							'breakpoint' => absint( gutengeek_get_xs_breakpoint_setting() ),
							'settings' => [
		...
		// print template html
		echo gutengeek_get_template_html( 'blocks/post.php', $template_args );
	}
